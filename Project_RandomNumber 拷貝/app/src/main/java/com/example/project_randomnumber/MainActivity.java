                    ...
                    public void run() {
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                guess.setText("提示訊息：請輸入 " + min + "～" + max + " 的數字");
                                ...
                                new View.OnClickListener() {
                                    ...
                                    public void onClick(View v) {
                                        ...
                                        if (input.getText().toString().matches("")) {
                                            ...
                                            guess.setText("提示訊息：不要空白！請輸入 " + min + "～" + max + " 的數字");
                                            ...
                                            if (in <= max && in >= min) { // 輸入值介於最大至最小可能值內
                                                if (in > ranNum) {
                                                    ...
                                                    time++;
                                                    guess.setText("恭喜猜中數字「" + ranNum + "」！您只花了 " + time + " 次就完成了！");
                                                ...
                                                guess.setText("提示訊息：請輸入 " + min + "～" + max + " 的數字，不要亂輸入啦！");
                                                time++;
                                            }
